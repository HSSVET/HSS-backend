...
public interface DocumentRepository extends JpaRepository<Document, Long> {
       ...
       @Query("SELECT DISTINCT d FROM Document d LEFT JOIN FETCH d.owner o LEFT JOIN FETCH d.animal a WHERE o.clinic.clinicId = :clinicId ORDER BY d.createdAt DESC")
       Page<Document> findByClinicId(@Param("clinicId") Long clinicId, Pageable pageable);
