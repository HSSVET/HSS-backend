...
@org.springframework.boot.test.autoconfigure.web.servlet.WebMvcTest(com.hss.hss_backend.controller.FileController.class)
@org.springframework.context.annotation.Import({ com.hss.hss_backend.config.SecurityConfig.class,
                com.hss.hss_backend.exception.GlobalExceptionHandler.class })
@ActiveProfiles("test")
